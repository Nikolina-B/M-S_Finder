...
import { HiOutlineArrowRight, HiOutlineArrowLeft } from "react-icons/hi"; // Dodana ikona za nazad
import { FaTrash, FaStar } from "react-icons/fa";
import { toggleFavoritesAction } from "@/app/actions/favorites";
import { revalidatePath } from "next/cache";
          ...
          <div key={movie.movieId} className={styles.card}>
            <div className={styles.imageContainer}>
              ...
              <form action={async () => {
                ...
                revalidatePath("/profile/favorites");
                // NAPOMENA: localStorage ne može ići ovdje jer je ovo Server Action.
                // To bi trebalo rješavati u Client komponenti ako je nužno.
              }}>
                <button type="submit" className={styles.trashBtn} aria-label="Remove from Wishlist">
                  <FaTrash />
                </button>
